...
void SYSTEM::comunicacao() 
{
	...
	if (rede[0][0]->cf_saida_leste->ack.read() == 1)
	{
		...
		rede[0][1]->buffer_oeste->din =  flit[0];
		rede[0][1]->buffer_oeste->add();
		rede[0][1]->roteamento_oeste.cordenada_destino.x =  flit[0].cordenadas_f.x;
		rede[0][1]->roteamento_oeste.cordenada_destino.y =  flit[0].cordenadas_f.y;
		...
		if ((rede[0][1]->roteamento_oeste.cordenada.x ==  flit[0].cordenadas_f.x) and (rede[0][1]->roteamento_oeste.cordenada.y ==  flit[0].cordenadas_f.y))
		{
			cout << "Chegou" << endl;\
	...
	{
		std::cout << "Gravar no buffer oeste r2" << endl;
		rede[1][0]->buffer_norte->din =  flit[0];
		rede[1][0]->buffer_norte->add();
		rede[1][0]->roteamento_norte.cordenada_destino.x =  flit[0].cordenadas_f.x;
		rede[1][0]->roteamento_norte.cordenada_destino.y =  flit[0].cordenadas_f.y;
		...
		if ((rede[1][0]->roteamento_norte.cordenada.x ==  flit[0].cordenadas_f.x) and (rede[1][0]->roteamento_norte.cordenada.y ==  flit[0].cordenadas_f.y))
		{
			cout << "Chegou" << endl;
			//jogar no buffer local
	...
	if (rede[0][1]->cf_saida_sul->ack.read() == 1)
	{
		...
		rede[1][1]->buffer_norte->din =  flit[0];
		rede[1][1]->buffer_norte->add();
		rede[1][1]->roteamento_norte.cordenada_destino.x =  flit[0].cordenadas_f.x;
		rede[1][1]->roteamento_norte.cordenada_destino.y =  flit[0].cordenadas_f.y;
		...
		if ((rede[1][1]->roteamento_norte.cordenada.x ==  flit[0].cordenadas_f.x) and (rede[1][1]->roteamento_norte.cordenada.y ==  flit[0].cordenadas_f.y))
		{
			cout << "Chegou..." << endl;
	...
	if (rede[0][1]->cf_saida_oeste->ack.read() == 1)
	{
		...
		if ((rede[0][0]->roteamento_leste.cordenada.x ==  flit[0].cordenadas_f.x) and (rede[0][1]->roteamento_leste.cordenada.y ==  flit[0].cordenadas_f.y))
		{
			cout << "Chegou" << endl;
	...
	if (rede[1][1]->cf_saida_norte->ack.read() == 1)
	{
		...
		rede[0][1]->buffer_sul->din =  flit[0];
		rede[0][1]->buffer_sul->add();
		rede[0][1]->roteamento_sul.cordenada_destino.x =  flit[0].cordenadas_f.x;
		rede[0][1]->roteamento_sul.cordenada_destino.y =  flit[0].cordenadas_f.y;
		...
		if ((rede[0][1]->roteamento_sul.cordenada.x ==  flit[0].cordenadas_f.x) and (rede[0][1]->roteamento_sul.cordenada.y ==  flit[0].cordenadas_f.y))
		{
			cout << "Chegou" << endl;
			//jogar no buffer local
	...
	if (rede[1][1]->cf_saida_oeste->ack.read() == 1)
	{
		...
		rede[1][0]->buffer_leste->din =  flit[0];
		rede[1][0]->buffer_leste->add();
		rede[1][0]->roteamento_leste.cordenada_destino.x =  flit[0].cordenadas_f.x;
		rede[1][0]->roteamento_leste.cordenada_destino.y =  flit[0].cordenadas_f.y;
		...
		if ((rede[1][0]->roteamento_leste.cordenada.x ==  flit[0].cordenadas_f.x) and (rede[1][0]->roteamento_leste.cordenada.y ==  flit[0].cordenadas_f.y))
		{
			cout << "Chegou" << endl;
			//jogar no buffer local
	...
	if (rede[1][0]->cf_saida_norte->ack.read() == 1)
	{
		...
		if ((rede[0][0]->roteamento_sul.cordenada.x ==  flit[0].cordenadas_f.x) and (rede[0][0]->roteamento_sul.cordenada.y ==  flit[0].cordenadas_f.y))
		{
			cout << "Chegou" << endl;
			//jogar no buffer local
	...
	{
		std::cout << "Gravar no buffer leste r3" << endl;
		rede[1][1]->buffer_oeste->din =  flit[0];
		rede[1][1]->buffer_oeste->add();
		rede[1][1]->roteamento_oeste.cordenada_destino.x =  flit[0].cordenadas_f.x;
		rede[1][1]->roteamento_oeste.cordenada_destino.y =  flit[0].cordenadas_f.y;
		...
		if ((rede[1][1]->roteamento_oeste.cordenada.x ==  flit[0].cordenadas_f.x) and (rede[1][1]->roteamento_oeste.cordenada.y ==  flit[0].cordenadas_f.y))
		{
			cout << "Chegou" << endl;
			//jogar no buffer local
